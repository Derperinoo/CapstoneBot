...
app.get('/geo',function(req, res){
	...
	axios.get('https://capstonetrafficbot.herokuapp.com/equirino')
...
app.get('/geo',function(req, res){
	...
	axios.get('https://capstonetrafficbot.herokuapp.com/mcarthur')
	  .then(function (response) {
	    console.log(response.data);
	    //chatbotResponse = response.jf1;
	    //sendText(sender, chatbotResponse)
...
app.get('/geo',function(req, res){
	...
	axios.get('https://capstonetrafficbot.herokuapp.com/jplaurel')
	  .then(function (response) {
	    console.log(response.data);
	    //chatbotResponse = response.jf1;
	    //sendText(sender, chatbotResponse)
...
app.get('/geo',function(req, res){
	...
	axios.get('https://capstonetrafficbot.herokuapp.com/ecowestdr')
	  .then(function (response) {
	    console.log(response.data);
	    //chatbotResponse = response.jf1;
	    //sendText(sender, chatbotResponse)
...
app.get('/geo',function(req, res){
	...
	axios.get('https://capstonetrafficbot.herokuapp.com/ecoland')
	  .then(function (response) {
	    console.log(response.data);
	    //chatbotResponse = response.jf1;
	    //sendText(sender, chatbotResponse)
...
app.get('/geo',function(req, res){
	...
	axios.get('https://capstonetrafficbot.herokuapp.com/matinaaplaya')
	  .then(function (response) {
	    console.log(response.data);
	    //chatbotResponse = response.jf1;
	    //sendText(sender, chatbotResponse)
